...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    # Fix permissions for all executables in opt/windscribe
    ...
    # Fix permissions for helper scripts
    chmod +x $out/etc/windscribe/*

    # Create symbolic links for main executables
  ...
  postFixup = ''
    ...
    # Wrap the other executables in opt/windscribe
