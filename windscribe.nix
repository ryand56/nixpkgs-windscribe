...
let
  ...
  custom_openssl_ech_draft = pkgs.openssl_3_3.overrideAttrs (finalAttrs: previousAttrs: {
    ...
    src = fetchFromGitHub {
      # https://github.com/Windscribe/Desktop-App/blob/bc84faf99c5f08b4b6b310fadf9a40eaadbdb771/tools/deps/install_openssl_ech_draft.py#L26
      owner = "sftcd";
      repo = "openssl";
  ...
  windscribe_full = stdenv.mkDerivation (finalAttrs: {
    ...
    preFixup = ''
      qtWrapperArgs+=(
        ...
        --prefix XDG_DATA_DIRS : ${qt6.qtbase}/share
        --prefix QT_XCB_GL_INTEGRATION : none
      )
    '';
  });
